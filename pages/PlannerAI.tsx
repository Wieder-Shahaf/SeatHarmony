...
const PlannerAI: React.FC = () => {
  return (
    <div className="flex-grow flex h-[calc(100vh-64px)] overflow-hidden">
      ...
      {/* Main Canvas */}
      <main className="flex-1 bg-background-lighter dark:bg-background-dark pattern-grid relative overflow-hidden cursor-grab active:cursor-grabbing">
         {/* Floating Toolbar */}
         <div className="absolute top-6 left-1/2 transform -translate-x-1/2 bg-white dark:bg-surface-dark px-2 py-1.5 rounded-xl shadow-lg flex items-center gap-2 border border-secondary/20 dark:border-gray-700 z-30">
          <button className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg text-gray-500 transition-colors" title="Zoom Out">
            <span className="material-icons-round text-xl">remove</span>
          </button>
          <span className="text-xs font-mono text-gray-400 w-12 text-center">100%</span>
          <button className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg text-gray-500 transition-colors" title="Zoom In">
            <span className="material-icons-round text-xl">add</span>
          </button>
          <div className="w-px h-6 bg-gray-200 dark:bg-gray-600 mx-1"></div>
          <button className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg text-primary transition-colors active" title="Select Tool">
            <span className="material-icons-round text-xl">near_me</span>
          </button>
          <button className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg text-gray-500 transition-colors" title="Pan Tool">
            <span className="material-icons-round text-xl">hand_gesture</span>
          </button>
        </div>

        {/* Canvas Area */}
        <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center p-20 scale-100 origin-center">
            {/* Table 1 */}
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                 <div className="relative">
                    ...
                    <div className="absolute top-1/2 -right-8 -translate-y-1/2 z-20">
                        <div className="w-14 h-14 rounded-full bg-primary text-white border-2 border-white dark:border-gray-800 shadow-md flex items-center justify-center relative ring-4 ring-primary/20 animate-pulse cursor-pointer">
                        ...
                        <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-4 w-64 z-50 animate-[fadeIn_0.3s_ease-out]">
                            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-primary/20 dark:border-gray-600 p-4 relative">
                                ...
                                <div className="mt-3 flex gap-2">
                                    <button className="text-xs bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 text-gray-600 dark:text-gray-300 px-2 py-1 rounded transition-colors">Dismiss</button>
