    ...
    <div className="flex-grow flex flex-col items-center relative overflow-hidden bg-background-lighter dark:bg-background-dark min-h-screen">
      ...
      <div className="flex-grow flex flex-col items-center justify-center w-full max-w-7xl px-4">
        ...
        <div className="max-w-4xl w-full text-center mt-20 mb-2 animate-[fadeInUp_1s_ease-out]">
          ...
          <p className="text-base text-text-main/80 dark:text-text-light/80 max-w-2xl mx-auto leading-relaxed mb-3">
            Upload your guest list and let our intelligent algorithm design the perfect layout for your event.
          </p>
        ...
        {/* Upload Card */}
        <div className="w-full max-w-[600px] mx-auto mb-4 relative z-10">
          <div
            onDragOver={handleDragOver}
            onDragLeave={handleDragLeave}
            onDrop={handleDrop}
            onClick={handleUploadAreaClick}
            className={`group relative bg-white dark:bg-surface-dark rounded-3xl min-h-[220px] flex flex-col justify-center p-5 shadow-soft border-2 border-dashed transition-all duration-300 ease-in-out cursor-pointer ${isDragging
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center text-center space-y-2 relative z-10">
              <div className={`w-8 h-8 rounded-full bg-background-light dark:bg-gray-800 flex items-center justify-center mb-1 transition-transform duration-300 ${isDragging ? 'scale-110' : 'group-hover:scale-110'}`}>
                <span className="material-icons-outlined text-2xl text-primary">cloud_upload</span>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 max-w-6xl mx-auto mb-4 w-full">
          <div className="bg-white/50 dark:bg-surface-dark/50 p-3 rounded-xl border border-secondary/30 dark:border-gray-600 hover:shadow-md transition-shadow">
            ...
            <h3 className="font-display text-base mb-1 text-text-main dark:text-text-light">Smart Grouping</h3>
          ...
          <div className="bg-white/50 dark:bg-surface-dark/50 p-3 rounded-xl border border-secondary/30 dark:border-gray-600 hover:shadow-md transition-shadow">
            ...
            <h3 className="font-display text-base mb-1 text-text-main dark:text-text-light">Stress Reduction</h3>
            <p className="text-xs text-text-main/70 dark:text-text-light/70 leading-relaxed">
          ...
          <div className="bg-white/50 dark:bg-surface-dark/50 p-3 rounded-xl border border-secondary/30 dark:border-gray-600 hover:shadow-md transition-shadow">
            ...
            <h3 className="font-display text-base mb-1 text-text-main dark:text-text-light">Visual Layouts</h3>
            <p className="text-xs text-text-main/70 dark:text-text-light/70 leading-relaxed">
